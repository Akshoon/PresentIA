    ...
    try {
      ...
      if (!isExportChromiumAvailable()) {
        return {
          success: false,
          message:
            "Export requires Chromium. Restart PresentIA and complete the Chromium setup step when prompted.",
        };
      }
      ...
      if (!chromiumExecutablePath) {
        return {
          success: false,
          message:
            "Export could not prepare Chromium for this Microsoft Store install. Restart PresentIA and try again.",
        };
      }

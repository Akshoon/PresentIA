...
ENV HF_HOME=/root/.cache/huggingface \
    PRESENTIA_FASTEMBED_ICON_CACHE_DIR=/root/.cache/presentia/fastembed-icons
...
RUN rm -rf /app/presentation-export \
    ...
    && chmod +x /app/presentation-export/py/convert-linux-* \
...
COPY --from=fastapi-builder /root/.cache/presentia/fastembed-icons /root/.cache/presentia/fastembed-icons
...
COPY scripts/presentia-terminal-banner.mjs /app/scripts/presentia-terminal-banner.mjs

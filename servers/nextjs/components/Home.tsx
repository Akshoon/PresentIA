...
import PresentIAMode from "./OnBoarding/PresentIAMode";
...
export default function Home() {
  ...
  const [selectedMode, setSelectedMode] = useState<string>("presentia")
  ...
  return (
    ...
    <div className="flex min-h-screen relative">
      ...
      <main className="w-full pl-20 pr-8 max-w-[1440px] mx-auto relative z-10">
        ...
        {step === 2 && selectedMode === "presentia" && <PresentIAMode currentStep={step} setStep={setStep} />}

...
const LoadingState = () => {
    ...
    const tips = [
        "Estamos diseñando tu presentación con magia de IA ✨",
        "Analizando tu contenido para crear diapositivas perfectas 📊",
        "Organizando la información para un impacto máximo 🎯",
        "Añadiendo elementos visuales para captar la atención de tu audiencia 🎨",
        "¡Ya casi está listo! Dando los últimos retoques ⚡️"
    ];

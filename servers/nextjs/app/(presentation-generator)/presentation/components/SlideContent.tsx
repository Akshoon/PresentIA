...
const SlideContent = ({
  ...
  const handleSubmit = async () => {
    if (!editPrompt.trim()) {
      notify.warning(
        "Se requiere instrucción",
        "Por favor, introduce una instrucción antes de enviar."
      );
      return;
    }
    setIsUpdating(true);
    ...
    try {
      ...
      if (response) {
        ...
        notify.success(
          ...
          "Tus cambios se aplicaron a esta diapositiva."
        );
        setEditPrompt("");
      } else {
        notify.error(
          "Error al editar la diapositiva",
          "El servidor no devolvió una diapositiva actualizada. Por favor, inténtalo de nuevo."
        );
      }
    } catch (error: any) {
      ...
      notify.error(
        "Error al editar la diapositiva",
        error.message || "Ocurrió un error al editar la diapositiva."
      );
    } finally {
      setIsUpdating(false);
    }
  ...
  const onDeleteSlide = async () => {
    try {
      if ((presentationData?.slides?.length ?? 0) <= 1) {
        notify.warning(
          "No se puede eliminar la diapositiva",
          "Una presentación debe contener al menos una diapositiva."
        );
        return;
      }
      ...
      notify.error(
        ...
        error.message || "Ocurrió un error al eliminar la diapositiva."
      );
    }
  };
  useEffect(() => {
        ...
        >
          ...
          {!showNewSlideSelection && (
            <div className="group-hover:opacity-100 hidden md:block opacity-0 transition-opacity my-4 duration-300">
              <ToolTip content="Añadir nueva diapositiva debajo">
                {!isStreaming && (
                  <div
                    onClick={() => {
            ...
            >
              ...
              >
                <PopoverTrigger asChild>
                  ...
                  >
                    <ToolTip content="Actualizar diapositiva usando una instrucción">
                ...
                >
                  <div className="border-b border-gray-100 px-4 py-3">
                    ...
                    <p className="mt-1 text-xs text-gray-500">
                      Describe cómo debería mejorarse esta diapositiva.
                    </p>
                  </div>
                  <form
                  ...
                  >
                    <Textarea
                      ...
                      value={editPrompt}
                      placeholder="Introduce tu instrucción aquí..."
              ...
              {slide?.speaker_note && (
                ...
                >
                  <PopoverTrigger asChild>
                    ...
                    >
                      <ToolTip content="Editar notas del orador">
                        <svg
              ...
              >
                <ToolTip content="Eliminar diapositiva">

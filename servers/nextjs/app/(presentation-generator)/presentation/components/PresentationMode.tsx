  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="hidden max-w-[250px] items-center gap-1.5 text-[11px] leading-tight text-gray-500 sm:flex"
          title="Atajos de teclado"
        >
          <Keyboard className="h-3.5 w-3.5 shrink-0" />
          <span>
            ← → espacio · Inicio/Fin · F pantalla completa · N notas · Esc salir
          </span>
        </div>
      </div>

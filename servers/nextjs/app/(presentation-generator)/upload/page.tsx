...
export const metadata: Metadata = {
  title: "PresentIA | Generador de presentaciones de IA de código abierto",
  description:
    "Generador de presentaciones de IA de código abierto con diseños personalizados, soporte multimodelos (OpenAI, Gemini, Ollama) y exportación a PDF/PPTX. Una alternativa gratuita a Gamma.",
  alternates: {
    canonical: "https://presentia.ai/create",
  },
  keywords: [
  ...
  openGraph: {
    title: "Crear presentación de datos | PresentIA",
    description:
      "Generador de presentaciones de IA de código abierto con diseños personalizados, soporte multimodelos (OpenAI, Gemini, Ollama) y exportación a PDF/PPTX. Una alternativa gratuita a Gamma.",
    type: "website",
    url: "https://presentia.ai/create",
    siteName: "PresentIA",
  },
  twitter: {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="flex flex-col items-center justify-center  mb-8 ">
        ...
        <p className="text-xl  font-syne text-[#101323CC]">Convierte prompts o documentos en presentaciones con IA</p>
      </div>

...
const TONE_LABELS: Record<ToneType, string> = {
    [ToneType.Default]: "Por defecto",
    [ToneType.Casual]: "Casual",
    [ToneType.Professional]: "Profesional",
    [ToneType.Funny]: "Divertido",
    [ToneType.Educational]: "Educativo",
    [ToneType.Sales_Pitch]: "Discurso de ventas",
};

const VERBOSITY_LABELS: Record<VerbosityType, string> = {
    [VerbosityType.Concise]: "Conciso",
    [VerbosityType.Standard]: "Estándar",
    [VerbosityType.Text_Heavy]: "Texto abundante",
};
                        ...
                        <div className="overflow-hidden rounded-[24px] border border-[#E7E9F2] bg-[#F3F3F6] shadow-[0_24px_80px_rgba(15,23,42,0.20)]">
                            <div className="flex items-start justify-between gap-4 bg-[#F8F8FA] px-6 py-[22px] ">
                                <div>
                                    ...
                                    <p className="mt-1 text-sm text-[#808080]">Ajustar el comportamiento de la presentación</p>
                                </div>
                                ...
                                <div className="flex items-start gap-2">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <Textarea
                                            ...
                                            placeholder="Guía a la IA: define la audiencia, el tono, los puntos clave o las restricciones."
                            ...
                            <div className="space-y-4 px-6 pb-5 pt-3.5 ">
                                <div className="flex items-center justify-between gap-3">
                                    <label className="font-syne text-sm font-semibold leading-none text-[#1F1D2A]">Tono</label>
                                    <Select
                                ...
                                <div className="flex items-center justify-between gap-3">
                                    <label className="font-syne text-sm font-semibold leading-none text-[#1F1D2A]">Detalle</label>
                                    <Select
                                ...
                                <div className="flex items-center justify-between gap-3">
                                    <label className="font-syne text-sm font-semibold leading-none text-[#1F1D2A]">Diapositiva de Título</label>
                                    <Switch

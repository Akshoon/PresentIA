    ...
    return (
        <div className="space-y-6 bg-[#F9F8F8] p-7 rounded-[12px] ">
            ...
            <div className="mb-4  bg-white p-10 pt-5 rounded-[12px]">
                <ToolTip content="Habilitar/Deshabilitar Generación de Imágenes" className='flex justify-end items-center'>
                ...
                <div className='flex items-center justify-between'>
                    ...
                    <div className=" max-w-[290px] pb-[50px]">
                        ...
                        <h3 className="text-xl font-normal text-[#191919] py-2.5">Configuración de generación de imágenes</h3>
                    ...
                    <div className=' '>
                                                ...
                                                <div className=" w-[205px]">
                                                    ...
                                                    <div className="relative">
                                                        <input
                                                            ...
                                                            placeholder={`Introduce tu ${provider.apiKeyFieldLabel}`}
                        ...
                        {!isImageGenerationDisabled && <div className='flex justify-end items-center mt-[18px]'>
                            ...
                            {llmConfig.IMAGE_PROVIDER === "comfyui" && <div className='w-full'>
                                <label className="block text-sm font-medium text-gray-700 mb-2">
                                    JSON del flujo de trabajo (Workflow)
                                </label>
                                <div className="relative">
                                    <textarea
                                        placeholder='Pega aquí el JSON del flujo de trabajo de ComfyUI (expórtalo vía "Export (API)" en ComfyUI)'
                    ...
                    <>
                        <div className="mb-4 rounded-lg border border-yellow-200 bg-yellow-50 p-3">
                            <p className="text-sm text-yellow-800">
                                No se encontraron modelos. Por favor, asegúrate de que las credenciales de tu proveedor son válidas y el proveedor seleccionado es accesible.
                            </p>
                        </div>
                        <div className="flex w-full justify-end">
                            <div className="w-[205px]">
                                <label className="mb-2 block text-sm font-medium text-gray-700">ID del modelo de imagen</label>
                                <input
                                    type="text"
                                    placeholder="ej. dall-e-3, gpt-image-1"

        ...
        <div className="flex flex-col items-start justify-between gap-8 lg:flex-row lg:gap-10">
          <div className="max-w-[300px] shrink-0 pb-2 lg:pb-[20px]">
            ...
            <p className="text-sm text-gray-500">
              Configura la búsqueda externa solo cuando la búsqueda web esté habilitada.
            </p>
          </div>
          <div className="w-full max-w-[360px] space-y-4">
            {!isWebSearchEnabled ? (
              <div className="rounded-lg border border-[#EDEEEF] bg-[#FAFAFA] p-4 text-sm text-[#4C5554]">
                La búsqueda web está deshabilitada actualmente. Habilítala para elegir la configuración del proveedor.
              </div>
            ) : (
              <>
                <div>
                ...
                {selected === "auto" && (
                  <div className="rounded-lg border border-[#D9D6FE] bg-[#F4F3FF] p-3 text-xs text-[#5146E5]">
                    Se prefiere la conexión web nativa del modelo cuando está disponible. De lo contrario, se utiliza la búsqueda externa de respaldo.
                  </div>
                )}

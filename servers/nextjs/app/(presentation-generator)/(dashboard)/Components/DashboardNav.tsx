        ...
        <div className="sticky top-0 right-0 z-50 py-[28px]   backdrop-blur ">
            <div className="flex xl:flex-row flex-col gap-6 xl:gap-0 items-center justify-between">
                <h3 className=" text-[28px] tracking-[-0.84px] font-unbounded font-normal text-[#101828] flex items-center gap-2">
                    ...
                    {activeTab ? (tabTranslations[activeTab] || activeItem?.label || activeTab.charAt(0).toUpperCase() + activeTab.slice(1)) : ""}
                </h3>
                <div className="flex  gap-2.5 max-sm:w-full max-md:justify-center max-sm:flex-wrap">
                    ...
                    {activeTab !== "playground" && activeTab !== "theme" && <Link
                        ...
                        aria-label="Crear nueva presentación"
                        style={{
                            borderRadius: "48px",
                    ...
                    >
                        ...
                        <span className="hidden md:inline">Nueva presentación</span>
                    ...
                    {activeTab === "theme" &&
                        <Link
                            ...
                            aria-label="Crear nuevos temas"
                            style={{
                                borderRadius: "48px",
                                background: "linear-gradient(270deg, #D5CAFC 2.4%, #E3D2EB 27.88%, #F4DCD3 69.23%, #FDE4C2 100%)",
                            }}
                        >
                            <span className="hidden md:inline">Nuevos temas</span>

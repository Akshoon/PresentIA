...
export const defaultNavItems = [
    { key: "dashboard" as const, label: "Panel", icon: LayoutDashboard },
    { key: "templates" as const, label: "Estándar", icon: Star },
    { key: "designs" as const, label: "Inteligente", icon: Brain },
        ...
        >
            <div>
                ...
                <Link href={`/dashboard`} className="flex items-center  pb-6 border-b border-[#E1E1E5]   gap-2    ">
                    <div className="bg-[#7C51F8] rounded-full cursor-pointer p-1 flex justify-center items-center mx-auto">
                        <img src="/logo-with-bg.png" alt="PresentIA logo" className="h-[40px] object-contain w-full" />
                    </div>
                </Link>
                <nav className="pt-6 font-syne" aria-label="Dashboard sections">
                    <div className="  space-y-6">
                        ...
                        >
                            ...
                            <span className="text-[11px] text-slate-800">Panel</span>
                        </Link>
                        <Link
                            prefetch={false}
                            href={`/templates`}
                        ...
                        >
                            <div className="flex flex-col cursor-pointer tex-center items-center gap-2  transition-colors">
                                ...
                                <span className="text-[11px] text-slate-800">Plantillas</span>
                            </div>
                        </Link>
                        <Link
                            prefetch={false}
                        ...
                        >
                            <div className="flex flex-col cursor-pointer tex-center items-center gap-2  transition-colors">
                                ...
                                <span className="text-[11px] text-slate-800">Temas</span>
                            </div>
                        </Link>
                    </div>
                </nav>
            ...
            >
                <div className="mb-4">
                    ...
                    <Link href="https://docs.presentia.ai/help" target="_blank" className="flex flex-col tex-center items-center gap-2  transition-colors"><HelpCircle className="w-4 h-4" /><span className="text-[11px] text-slate-800">Ayuda</span></Link>
                </div>
                <div className="mb-4">

                    <Link href="https://discord.com/invite/9ZsKKxudNE" target="_blank" className="flex flex-col tex-center items-center gap-2  transition-colors"><img src="/discord.png" alt="Discord" className="w-5 h-5 rounded-full object-cover border border-[#EDEEEF]" /><span className="text-[11px] text-slate-800">Comunidad</span></Link>
                </div>

    ...
    return (
        <div
            ...
            <div className='px-5 py-4 bg-white flex items-center gap-4 overflow-hidden border-t  border-[#EDEEEF]'>
                ...
                <div>
                    <h4 className='text-[#191919] text-sm font-semibold '>Crear Plantilla</h4>
                    <p className='flex text-[#808080] text-sm  font-medium items-center gap-2'>Diseña tu propia plantilla</p>
                </div>

...
export const PresentationCard = ({
  ...
  const handleDelete = async () => {
    ...
    if (response?.success) {
      ...
      notify.success("Presentación eliminada", "La presentación ha sido eliminada de tu panel.");
      setShowDeleteDialog(false);
      if (onDeleted) {
        onDeleted(id);
      }
    } else {
      notify.error("No se pudo eliminar la presentación", response?.message || "Ocurrió un error al eliminar la presentación.");
    }
    setIsDeleting(false);
  };

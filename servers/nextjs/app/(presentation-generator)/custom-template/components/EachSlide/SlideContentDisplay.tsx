          ...
          <div className="mb-4 flex items-center justify-between bg-[#EDE9FE] border border-[#C4B5FD] rounded-xl px-4 py-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-[#5B21B6]">
                Mostrando vista previa generada por IA
              </span>
            </div>
            {onClearPreview && (
              <Button
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h4 className="text-base font-semibold text-[#991B1B] mb-1">
              {isImageTooLarge ? "Imagen demasiado grande" : "Error en la conversión"}
            </h4>
            <p className="text-sm text-[#B91C1C] mb-4">
              {isImageTooLarge
                ? "La imagen de esta diapositiva supera el límite de 5 MB. Intenta usar un archivo PPTX con menor resolución o comprimir las imágenes."
                : slide.error
              }
            </p>
            <button

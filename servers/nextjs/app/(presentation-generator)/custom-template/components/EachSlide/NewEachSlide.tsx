...
const EachSlide: React.FC<EachSlideProps> = ({
  ...
  const handleDeleteSlide = () => {
    const confirmed = window.confirm(
      `¿Estás seguro de que quieres eliminar la diapositiva ${index + 1}? Esta acción no se puede deshacer.`
    );
    if (!confirmed) return;
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-base font-semibold text-[#111827] tracking-tight">
                {compiledLayout?.layoutId || `Diapositiva ${index + 1}`}
              </h3>
          ...
          <div className="flex items-center gap-1.5">
            ...
            <div className="flex items-center bg-gray-50/80 rounded-lg p-1 gap-0.5">
                  ...
                  <div className="p-4">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <span className="text-sm font-semibold text-gray-800">Editar con IA</span>
                          <p className="text-[10px] text-gray-400">Aplica cambios y ajustes con IA</p>
                        </div>
                      </div>
                      <button
                        type="button"
                    ...
                    <textarea
                      ...
                      rows={3}
                      autoFocus
                      placeholder="¿Qué cambios te gustarían? Ej. 'Haz el título más grande' o 'Cambia los colores al tema azul'"
                      disabled={isUpdating}
              ...
              {/* Schema Button */}
              <ToolTip content="Editar esquema de contenido">
                <button
                  onClick={() => {
            ...
            {/* Undo/Redo Group */}
            <div className="flex items-center bg-gray-50/80 rounded-lg p-1 gap-0.5">
              <ToolTip content={canUndo ? "Deshacer (Ctrl+Z)" : "Nada que deshacer"}>
                <button
                  onClick={undo}
              ...
              <ToolTip content={canRedo ? "Rehacer (Ctrl+Shift+Z)" : "Nada que rehacer"}>
                <button
                  onClick={redo}
            ...
            {/* Re-Construct Button */}
            <ToolTip content="Rediseñar esta diapositiva">
              <button
        ...
        {isSlideProcessing && (
          <div className="mt-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-medium text-[#7A5AF8]">Generando el diseño de la diapositiva...</span>
            </div>
            <Timer duration={120} />
          </div>
        )}

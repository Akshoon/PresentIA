                ...
                <div className="px-6 py-5 border-b border-[#F3F4F6] bg-gradient-to-r from-[#FAFAFA] to-white">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h2 className="text-xl font-semibold text-[#111827]">Vista Previa de Diapositivas</h2>
                                <p className="text-sm text-[#6B7280] mt-0.5">
                                    {slideCount} {slideCount === 1 ? 'diapositiva lista' : 'diapositivas listas'}
                                    {fontCount > 0 && (
                                        <> · {fontCount} {fontCount === 1 ? 'fuente aplicada' : 'fuentes aplicadas'}</>
                                    )}
                                </p>
                            </div>
                        </div>
                ...
                <div className="px-6 py-5 border-t border-[#F3F4F6] bg-gradient-to-r from-[#FAFAFA] to-white">
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                        <p className="text-sm text-[#6B7280] max-w-md text-center sm:text-left">
                            Listo para generar tu plantilla. Cada diapositiva se convertirá en un componente de React reutilizable.
                        </p>
                        <Button
                            size="lg"

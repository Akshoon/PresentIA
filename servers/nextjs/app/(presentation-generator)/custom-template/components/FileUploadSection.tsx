      ...
      <div className=" max-w-[650px] w-full mx-auto px-2 md:px-0 ">
        ...
        >
          ...
          >
            ...
            <p className='text-xs font-medium text-black'>Subir archivo PPTX</p>
          </div>
        </div>
                ...
                {!selectedFile ? <>
                  ...
                  <div className='absolute inset-0 flex flex-col items-center justify-center'>
                    ...
                    <p className='pt-3 text-xs font-normal text-[#808080] tracking-[-0.12px] text-center'>
                      <span className='text-[#808080] underline underline-offset-4'>Haz clic para subir</span> o arrastra y suelta.
                    </p>
                  </div>
                  ...
                  <div className="flex gap-2 items-center justify-center mx-10 w-full">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs font-normal text-[#808080] tracking-[-0.12px]">Presentación ( {(selectedFile.size / (1024 * 1024)).toFixed(2)} MB)</p>
                    </div>
                ...
                <div className="min-w-[140px] w-full">
                  {isProcessing ? (
                    <div className="flex items-center justify-end gap-3" aria-live="polite" aria-label="Processing">
                      ...
                      <p className="text-sm font-medium text-[#9A9AA6] tracking-[-0.1px]">Procesando</p>
                      {slides.length > 0 ? (
                        <p className="text-sm font-medium text-[#9A9AA6] tracking-[-0.1px]">
                          {completedSlides}/{slides.length} Diapositivas
                        </p>
                      ) : null}
                      <style jsx>{`
                      @keyframes stripes {
        ...
        <ul className="flex items-center max-w-[85%] md:max-w-[70%] mx-auto  mt-5 justify-between gap-2.5">
          <li className="flex items-center gap-1">
            ...
            <p className="md:text-sm text-[10px] font-normal text-[#3A3A3A] ">Solo PPTX</p>
          </li>
          <li className="flex items-center gap-1">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
              <circle cx="8.5" cy="8.17041" r="4.5" fill="#EBE9FE" />
          ...
          <li className="flex items-center gap-1">
            ...
            <p className="md:text-sm text-[10px] font-normal text-[#3A3A3A] ">Generación en 5 min</p>
          </li>
        </ul>
        ...
        <div className="mt-4 px-4 py-3 rounded-lg border border-[#EBE9FE]  flex items-start gap-2 shadow-md">
          ...
          <p className="text-sm md:text-base font-medium text-[#20165C] tracking-[-0.13px]">
            <span className="font-bold text-[#5B49A1]">Nota:</span> Cada diapositiva se envía al modelo de texto configurado como una <span className="font-semibold">captura de pantalla y una referencia HTML</span>. Solo los modelos con <span className="font-semibold">capacidad de visión</span> (entrada de imagen) pueden interpretar el diseño fielmente. Los modelos de solo texto pueden fallar o generar diseños deficientes; elige un modelo de visión en la Configuración de tu proveedor.
          </p>
        </div>

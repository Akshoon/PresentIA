    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      ...
      <DialogContent className="sm:max-w-[480px] " style={{ zIndex: 1000 }}>
        <DialogHeader>
          ...
          <DialogDescription>
            Asigna un nombre claro a tu plantilla y una descripción opcional para encontrarla más tarde.
          </DialogDescription>
        </DialogHeader>
        <div className="grid gap-5 py-4">
          <div className="grid gap-2">
            ...
            <Input
              ...
              placeholder="ej. Presentación Tecnológica Moderna"
              disabled={isSaving}
              className="w-full"
              aria-required
            />
          ...
          <div className="grid gap-2">
            ...
            <Textarea
              ...
              placeholder="Agrega un breve resumen de para qué es mejor esta plantilla..."
              disabled={isSaving}
          ...
          {isSaving && (
            <div className="flex items-center gap-2 text-sm text-gray-600">
              ...
              <span>Guardando tu plantilla. Esto puede tardar un momento…</span>
            </div>
          )}
        </div>
        <DialogFooter>

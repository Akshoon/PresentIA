    ...
    if (customLoading) {
      return (
        <div className="flex items-center justify-center py-12 font-syne">
          ...
          <span className="ml-3 text-gray-600">Cargando plantillas personalizadas...</span>
        </div>
      );
    }
    ...
    <div className="space-y-[30px] mb-4">
      <div>
        <div className="flex items-center justify-between mb-3">
          <h3 className="text-base font-semibold text-gray-900 font-syne">Personalizadas</h3>
        </div>
        {customTemplateCards}
      </div>
      <div>
        <h3 className="text-base font-semibold text-gray-900 mb-3 font-syne">Predeterminadas</h3>

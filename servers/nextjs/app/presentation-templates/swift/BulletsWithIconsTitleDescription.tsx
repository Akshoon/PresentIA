...
const ItemSchema = z
  ...
  .default({
    icon: {
      __icon_url__:
        "https://presentia-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/graduation-cap-bold.svg",
...
const Schema = z
    ...
    items: z
      ...
      .default([
        ...
        },
        {
          icon: {
            __icon_url__:
              "https://presentia-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/user-bold.svg",
            __icon_query__: "feature icon",
          },
          title: "Lorem ipsum dolor",
          description:
        ...
        },
        {
          icon: {
            __icon_url__:
              "https://presentia-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/calendar-blank-bold.svg",
            __icon_query__: "feature icon",
          },
          title: "Lorem ipsum dolor",
          description:
        ...
        },
        {
          icon: {
            __icon_url__:
              "https://presentia-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/x-bold.svg",
            __icon_query__: "feature icon",
          },
          title: "Lorem ipsum dolor",
          description:
  ...
  .default({
    ...
    items: [
      {
        icon: { __icon_url__: "https://presentia-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/graduation-cap-bold.svg", __icon_query__: "feature icon" },
        title: "Lorem ipsum dolor",
        description:
          "Concise supporting text under the first icon explaining the point.",
      },
      {
        icon: { __icon_url__: "https://presentia-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/user-bold.svg", __icon_query__: "feature icon" },
        title: "Lorem ipsum dolor",
        description:
          "Concise supporting text under the second icon explaining the point.",
      },
      {
        icon: { __icon_url__: "https://presentia-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/calendar-blank-bold.svg", __icon_query__: "feature icon" },
        title: "Lorem ipsum dolor",
        description:
          "Concise supporting text under the third icon explaining the point.",
      },
      {
        icon: { __icon_url__: "https://presentia-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/x-bold.svg", __icon_query__: "feature icon" },
        title: "Lorem ipsum dolor",
        description:
          "Concise supporting text under the fourth icon explaining the point.",
      },
